// Safe operating space threshold-risk scoring engine in Rust.
...
impl BoundaryState {
    ...
    fn systemic_threshold_risk(&self, mean_other_risk: f64) -> f64 {
...
fn main() {
    ...
    println!(
        "Systemic threshold risk: {:.4}",
        boundary.systemic_threshold_risk(mean_other_risk)
    );
}
