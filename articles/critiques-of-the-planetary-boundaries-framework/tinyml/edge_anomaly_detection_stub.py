...
This illustrates how edge devices might flag anomalous environmental
signals before escalating them to a governance or analytics layer.
"""
...
if __name__ == "__main__":
    ...
    for reading in stream:
        print({"reading": reading, "anomaly": detector.update(reading)})
