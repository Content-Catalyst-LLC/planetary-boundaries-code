"""
TinyML-oriented land-change anomaly detection scaffold.

This illustrates how low-power or edge systems might flag unusual
vegetation-index, canopy-cover, soil-moisture, fire-risk, or disturbance
signals before they are integrated into land-system dashboards.
"""
...
if __name__ == "__main__":
    ...
    # Example vegetation-index-like signal from an edge monitoring device.
    stream = [0.72, 0.71, 0.73, 0.70, 0.71, 0.72, 0.49, 0.70]

    for reading in stream:
        print({"land_signal": reading, "anomaly": detector.update(reading)})
